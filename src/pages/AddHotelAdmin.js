...
export default function AddHotelAdmin() {
    ...
    const handleAdminSubmit = async () => {
        ...
        const result = await createHotelAdmin({
            user: {
        ...
        if (result.status === "success") {
            ...
            swal("Error while Creating Hotel Admin", `${result.message} \n\n Please Try again`);
          }
                ...
                <Card>
                    ...
                    >
                        <Button
                            ...
                            size="large"
                            component="label"
                        >{adminInfo.isLoading ? "Loading . . ." : "Save Hotel Admin"} </Button>
                    </Grid>
                    <br />
                    <br />
                </Card>
